...
// Demo roadmap items for Apex Roofing Solutions
const DEMO_ROADMAP_ITEMS: RoadmapItem[] = [
  // Management Independence
  {
    ...
    description: 'Create comprehensive SOPs for estimating, production scheduling, and quality control processes',
    category: 'strategic',
    priority: 'critical',
    status: 'in_progress',
  ...
  },
  {
    ...
    description: 'Recruit experienced operations manager to handle day-to-day production decisions',
    category: 'strategic',
    priority: 'high',
    status: 'pending',
  ...
  // Financial Records
  {
    ...
    description: 'Standardize QuickBooks chart of accounts to align with industry standards for roofing contractors',
    category: 'monthly_close',
    priority: 'high',
    status: 'completed',
    expected_impact_ev: 50000,
    effort_level: 'low',
    estimated_hours: 8,
    due_date: '2024-12-15',
  ...
  },
  {
    ...
    description: 'Track labor, materials, and overhead by job for accurate profitability analysis',
    category: 'strategic',
    priority: 'high',
    status: 'in_progress',
  ...
  // Recurring Revenue
  {
    ...
    description: 'Create annual roof maintenance contracts with inspection and minor repair services',
    category: 'strategic',
    priority: 'critical',
    status: 'pending',
  ...
  },
  {
    ...
    tenant_id: 'demo',
    driver_key: 'recurring_revenue',
    title: 'Set Up Gutter Cleaning Service',
    description: 'Add recurring gutter cleaning packages to complement roofing services',
    category: 'strategic',
    priority: 'medium',
    status: 'pending',
    expected_impact_ev: 85000,
    effort_level: 'medium',
    estimated_hours: 20,
    due_date: '2025-04-30',
    completed_at: null,
  ...
  // Operational Systems
  {
    ...
    description: 'Deploy CRM to track leads, customer communications, and follow-up sequences',
    category: 'strategic',
    priority: 'high',
    status: 'completed',
  ...
  },
  {
    ...
    tenant_id: 'demo',
    driver_key: 'operational_systems',
    title: 'Automate Scheduling & Dispatch',
    description: 'Implement digital scheduling system with crew assignment and route optimization',
    category: 'strategic',
    priority: 'medium',
    status: 'pending',
    expected_impact_ev: 65000,
    effort_level: 'medium',
    estimated_hours: 25,
    due_date: '2025-05-15',
    completed_at: null,
  ...
  // Customer Diversity
  {
    ...
    description: 'Diversify revenue base so no single customer exceeds 15% of annual revenue',
  ...
  },
  {
    ...
    tenant_id: 'demo',
    driver_key: 'customer_diversity',
    title: 'Expand Commercial Client Base',
    description: 'Target property management companies and commercial building owners',
    category: 'strategic',
    priority: 'medium',
    status: 'pending',
  ...
  // Market Outlook
  {
    ...
    title: 'Establish Insurance Restoration Partnerships',
    description: 'Build relationships with insurance adjusters and become preferred contractor',
    category: 'strategic',
    priority: 'medium',
    status: 'in_progress',
    expected_impact_ev: 120000,
    effort_level: 'medium',
    estimated_hours: 35,
    due_date: '2025-03-31',
    completed_at: null,
  ...
  },
  {
    ...
    tenant_id: 'demo',
    driver_key: 'market_outlook',
    title: 'Get GAF Master Elite Certification',
    description: 'Achieve premium manufacturer certification for competitive advantage',
    category: 'compliance',
    priority: 'high',
    status: 'completed',
    expected_impact_ev: 80000,
    effort_level: 'medium',
    estimated_hours: 40,
    due_date: '2024-10-31',
...
export function ValuationRoadmap({ accessToken, isDemoMode = false }: ValuationRoadmapProps) {
  ...
  const fetchRoadmap = async () => {
    try {
      ...
      // Demo mode - use hardcoded Apex Roofing Solutions data
      if (isDemoMode) {
        setItems(DEMO_ROADMAP_ITEMS)
        return
      }
